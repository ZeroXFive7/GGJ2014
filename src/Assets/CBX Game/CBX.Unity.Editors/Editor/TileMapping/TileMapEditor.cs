namespace CBX.Unity.Editors.Editor
{
    ...
    public class TileMapEditor : Editor
    {
		...
		/// <summary>
		/// Holds the location of the previous mouse hit location
		/// </summary>
		private Vector3 startMouseHitPos;
        ...
        private void Draw()
        {
			...
			var windDirection = this.GetMouseMovementDirection();
            ...
            var tilePositionInLocalSpace = new Vector3((tilePos.x * map.TileWidth) + (map.TileWidth / 2), 0, (tilePos.y * map.TileHeight) + (map.TileHeight / 2));
			...
			cube.transform.rotation = windDirection;
        }
		...
		private Quaternion GetMouseMovementDirection()
		{
			return Quaternion.LookRotation(mouseHitPos - startMouseHitPos);
		}
        ...
        private void RecalculateMarkerPosition()
        {
			...
			var pos = new Vector3(tilepos.x * map.TileWidth, 0, tilepos.y * map.TileHeight);
